...
frappe.pages['driverlocation'].on_page_load = function(wrapper)
{
		...
		wrapper.DriverLocation = new delivery_management.Dashboard(wrapper);
...
({
	...
	make_fun: function(){
            this.page.set_title(__("Dashboard") + " - " + __("Actual Path"));
...
$.getScript( "http://maps.google.com/maps/api/js?key=AIzaSyCGWFz53x4ukwNmX8B0U51qa9W0t5_df3Y&&sensor=false", function( data, textStatus, jqxhr ) {
  console.log( "Load was performed." );
		...
		var html = frappe.render_template("locationmaptemplate", {"data":"this is encripted data"})
		$("#myGrid1").html(html)
