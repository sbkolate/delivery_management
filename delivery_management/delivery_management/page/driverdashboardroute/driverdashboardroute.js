...
$.getScript( "http://maps.google.com/maps/api/js?key=AIzaSyCGWFz53x4ukwNmX8B0U51qa9W0t5_df3Y&&sensor=false", function( data, textStatus, jqxhr ) {
  console.log( "Load was performed." );
	...
	var directionsService = new google.maps.DirectionsService();
		...
		// var source = new google.maps.LatLng(b.message[i].start_lat, b.message[i].start_long);
		// var destination = new google.maps.LatLng(b.message[i].stop_lat, b.message[i].stop_long);
		var request = {
			origin: source,
